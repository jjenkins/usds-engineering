...
2. Please write code to download the current eCFR data, store the data server-side, create APIs that can retrieve the server-side stored data, and provide a UI to analyze it for items such as word count per agency, historical changes over time, and a checksum for each agency. 
...
3. There should be a way for users to review the results.

4. **Please submit this assignment via KiteWorks by the deadline your USDS Recruiter provided. If you have questions or need more time, please let your Recruiter know.**
